var fixLeadApp = angular.module("fixLeadApp", ['ngRoute',
  'leadControllers', 'ngResource']);

fixLeadApp.directive('rangeSlider', [function () {
    return {
        replace: true,
        restrict: 'E',
        require: 'ngModel',
        template: '<input type="range" ng-model-options="{debounce: 500}"/>',
